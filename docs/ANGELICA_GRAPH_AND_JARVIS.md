...
> **Υπερκαλύφθηκε:** ο Thomas ζήτησε **πλήρες σβήσιμο Jinhua** (`29`). Το Neo4j γράφημα φεύγει μαζί με το stack. Δες [`JINHUA_FULL_WIPE.md`](JINHUA_FULL_WIPE.md).

**Ναι, ήταν εφικτό** να κρατηθεί μόνο το γράφημα δίπλα σε Jarvis. Η νεότερη απόφαση είναι wipe, όχι keep-graph.
