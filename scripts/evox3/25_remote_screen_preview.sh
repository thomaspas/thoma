...
#   ./scripts/evox3/25_remote_screen_preview.sh status
...
cmd_start() {
  ...
  if preview_running && health_ok; then
    ...
    printf 'Stop: ./scripts/evox3/25_remote_screen_preview.sh stop\n'
    return 0
  fi
  ...
  printf '\nStop: ./scripts/evox3/25_remote_screen_preview.sh stop\n'
  ok "25_remote_screen_preview.sh started"
}
