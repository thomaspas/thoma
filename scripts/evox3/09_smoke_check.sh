...
printf '  4) Done — paste 21_remote_verify output to Cursor if debugging (cloud)\n'
printf '  5) Live UI / monitor (Desktop Remote SSH): docs/CURSOR_REMOTE_SSH.md\n'
printf '     snapshot: ./scripts/evox3/25_kiosk_snapshot.sh\n'
printf '     GNOME RDP: ./scripts/evox3/26_gnome_remote_desktop.sh\n'
printf '     :5173 refused: ./scripts/evox3/27_web_ui_preview.sh\n'
printf '\nRelaunch kiosk now:\n'
